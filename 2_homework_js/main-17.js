...
// if (age < 18) {
//   let discount = 10;
//   console.log(`Размер скидки составляет ${discount}%`);
...
switch (true) {
  ...
  case age > 65:
    ...
    break;
  default:
    console.log("Пожалуйста, введите корректный возраст числом");
}
...
if (weight <= 0 || isNaN(weight)) {
  ...
  let finalCount = baseCount * ratio;
  alert(`Итоговая стоимость доставки: ${finalCount}$.`);
}
